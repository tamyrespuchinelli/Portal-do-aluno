...
<body class="center clearfix">
	...
	<section class="container-atualização">
    	<div class="desktop">
            ...
            <form action="professor_atualizado.php" method="POST">
        <fieldset>
                       
			<label for="nome">Nome:</label>
            <input id="nome" name="p_nome" placeholder="Seu nome"></input> <br>
           ...
           <label for="matricula">Matricula:</label>
            ...
            <input type="submit" name="submit" class="button" value="Atualizar"></input>
            ...
            <a class="but3" href="menu-professor.php">
